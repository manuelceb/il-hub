...
urlpatterns = [
    ...
    path("profiles/library", views.LibraryProfileView.as_view(), name="library_profile"),
    ...
    path("profiles/library/edit", views.LibraryProfileEditView.as_view(), name="library_profile_edit"),
    path("profiles/blog/edit", views.BlogProfileEditView.as_view(), name="blog_profile_edit"),
]
